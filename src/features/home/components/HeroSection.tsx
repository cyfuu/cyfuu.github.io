  ...
  return (
    ...
    >
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          {/* Main Title */}
          <h1 className="mb-1 sm:mb-2 text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight">
          ...
          {/* Shuffling Roles */}
          <h2 className="mb-6 sm:mb-8 text-base sm:text-2xl md:text-3xl font-medium text-[--color-primary]/90 min-h-[40px] flex items-center whitespace-normal sm:whitespace-nowrap overflow-hidden">
            <ShufflingRoles />
          </h2>
