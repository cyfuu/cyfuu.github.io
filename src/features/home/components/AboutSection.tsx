      ...
      <div className="flex-1 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          {aboutItems.map((item) => (
            ...
            >
              {/* Card Header */}
              <div className="flex items-center gap-4 sm:block mb-3 sm:mb-0">
                
                {/* Icon Container */}
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[--color-primary]/10 flex shrink-0 items-center justify-center mb-0 sm:mb-5 border border-white/5">
                ...
                {/* Title */}
                <h3 className="mb-0 sm:mb-3 text-lg sm:text-xl font-semibold text-white">
                  {item.title}
                </h3>
              </div>
